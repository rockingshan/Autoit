...
While $i < 81
	...
	MouseClick("left",414,118,1)
	Sleep(1500)
	MouseClick("left",579,273,2)
	Sleep(800)
	Send($sCellValue)
	Sleep(800)
	MouseClick("left",1888,366,1)
	Sleep(500)
	MouseClick("left",993,740,1)
	Sleep(250)
	Send("208002")
	#Sleep(800)
	#MouseClick("left",1202,737,2)
	#Send("{DEL}")
	Sleep(800)
	MouseClick("left",960,811,1)
	#Send("{ENTER}")
	Sleep(250)
	MouseClick("left",1860,932,1)
	Sleep(2000)
	$i = $i + 1
	WEnd
